...
const TELL_EN = {
 ...
 "Deildegast":"Starts at 3.0 m/s (like a Revenant) and does NOT speed up with line-of-sight — constant unless you slow it down yourself. Every unique item (NOT your own equipment) you've moved/thrown since its last hunt drops its speed by 0.1 m/s (floor of 0.4 m/s at ~26 items) — dead players count too. Counter: throw items BEFORE the hunt — it resets after every hunt, so get back to work.",
};
const HUNT_EN = {
